...
Stmt : _SYMB_5 {  $$ = new Empty(); $$->line_number = yy_mylinenumber;  }
  ...
  | _SYMB_32 _SYMB_0 Expr _SYMB_1 Stmt {  $$ = new While($3, $5); $$->line_number = yy_mylinenumber;  }
...
;
Type : _SYMB_27 {  $$ = new Int(); $$->line_number = yy_mylinenumber;  }
  | _SYMB_29 {  $$ = new Str(); $$->line_number = yy_mylinenumber;  }
  | _SYMB_23 {  $$ = new Bool(); $$->line_number = yy_mylinenumber;  }
  | _SYMB_31 {  $$ = new Void(); $$->line_number = yy_mylinenumber;  }
;
...
Expr5 : _SYMB_9 Expr6 {  $$ = new Neg($2); $$->line_number = yy_mylinenumber;  }
  | _SYMB_10 Expr6 {  $$ = new Not($2); $$->line_number = yy_mylinenumber;  }
  | Expr6 {  $$ = $1;  }
;
